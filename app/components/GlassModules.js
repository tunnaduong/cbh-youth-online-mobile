...
// glass shader always reads a subtle dark tint in dark mode / light tint in
// light mode instead of rendering untinted (which looks washed-out/glassy
// with no grounding against busy content behind it). Centralized here
// instead of each call site hand-picking its own rgba value, which had
// drifted to visibly different opacities (0.15 to 0.6) across the app.
const androidGlassTint = (isDarkMode) =>
  isDarkMode ? "rgba(0, 0, 0, 0.28)" : "rgba(255, 255, 255, 0.28)";
