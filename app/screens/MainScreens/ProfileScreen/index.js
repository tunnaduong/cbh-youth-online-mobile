  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="mx-4 mt-3 bg-gray-200 p-4 rounded-xl">
        ...
        <View className="mx-4 flex-row items-center justify-between">
          <TouchableOpacity className="gap-1 justify-center items-center bg-[#C7F0C2] px-[8px] py-[4px] rounded-xl border border-[#2D8824]">
          ...
          <TouchableOpacity className="gap-1 justify-center items-center bg-white px-[8px] py-[4px]">
            ...
            <Text className="font-extrabold text-lg">10</Text>
          </TouchableOpacity>
          <TouchableOpacity className="gap-1 justify-center items-center bg-white px-[8px] py-[4px]">
            <Text className="font-semibold text-xs">Người t.dõi</Text>
            <Text className="font-extrabold text-lg">7</Text>
          </TouchableOpacity>
          <TouchableOpacity className="gap-1 justify-center items-center bg-white px-[8px] py-[4px]">
            <Text className="font-semibold text-xs">Thích</Text>
            <Text className="font-extrabold text-lg">20</Text>
          </TouchableOpacity>
          <TouchableOpacity className="gap-1 justify-center items-center bg-white px-[8px] py-[4px]">
            <Text className="font-semibold text-xs">Điểm</Text>
            <Text className="font-extrabold text-lg">142</Text>
          </TouchableOpacity>
        </View>

        {/* Recent posts */}
        {/* Loop from state using map */}
        {userData?.recent_posts.length === 0 && (
          <View>
            <Image
        ...
        {userData?.recent_posts.map((post) => (
          <PostItem key={`post-${post.id}`} item={post} />
        ))}
