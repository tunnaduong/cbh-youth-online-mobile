...
const getCategoryDescription = (desc, t) => {
  ...
  const descMap = {
    ...
    "là nơi tập hợp những tín đồ yêu thích trò chơi điện tử. tại đây, bạn có thể thảo luận về game mới, chia sẻ kinh nghiệm, hướng dẫn chơi, cũng như tham gia các sự kiện và giao lưu với cộng đồng game thủ khác.": "gamingWorldDesc",
